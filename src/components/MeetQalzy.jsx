        ...
        <div className="flex justify-center mb-12 md:mb-16">
          <div className="relative">
            <img
              ...
              className="w-64 sm:w-80 md:w-166 xl:w-178 lg:w-lg h-auto object-contain drop-shadow-2xl"
            />
          </div>
        </div>
        ...
        <div className="relative max-w-8xl mx-auto">
          <div className="flex justify-center items-center">
            <div className="relative">
              ...
              <div className="absolute md:bottom-1/6 md:left-1/20 sm:bottom-1/5 sm:left-1/20  lg:bottom-1/8 lg:left-1/20 bottom-1/4 left-1/22 xl:left-1/17 xl:bottom-1/10 transform translate-x-1/2 translate-y-8">
                <img
