  ...
  return (
    <section className="relative w-full py-16 sm:py-20 md:py-24 lg:py-28 overflow-hidden">
      ...
      <div className="relative z-10 px-4 sm:px-6 md:px-8 text-left xl:left-1/5  lg:left-1/8">
        {/* Heading */}
        <h2
          className="text-[48px] sm:text-[40px] md:text-[48px] lg:text-[52px] xl:text-[56px] 2xl:text-[60px] 
    font-normal leading-[100%] tracking-[0%] text-white lg:text-left text-center  mb-3 sm:mb-4 font-family-inter"
        ...
        {/* Subheading */}
        <p className=" font-family-inter text-[24px] font-bold leading-[100%] tracking-[0%] text-white text-center lg:text-left mb-2">
          Enter to win a Nutriscale and get 25% off
        </p>

        {/* Description */}
        <p className="text-[16px] font-normal leading-[100%] tracking-[0.04em] text-white/80 lg:text-left text-center   font-family-helvetica">
        ...
        <form onSubmit={handleSubmit} className="mt-4">
          <div className="flex flex-col gap-3 items-center lg:items-start ">
            ...
            <input
              ...
              required
              className="w-full sm:w-75 md:w-[320px] lg:w-85 xl:w-90 2xl:w-95
    ...
    transition-all"
            ...
            <button
              type="submit"
              className="w-full sm:w-72.5 md:w-75 lg:w-[320px] xl:w-85
